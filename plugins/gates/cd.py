...
async def premium(_, m: Message):
    ...
    r1_headers = {'X-Requested-With':'XMLHttpRequest'}
    r1 = r.get("https://www.countrydoor.com/on/demandware.store/Sites-CountryDoor-Site/default/Product-Variation?pid=J88636&dwvar_J88636_option=788636&dwvar_J88636_color=6BUR&Quantity=1&format=ajax&productlistid=undefined", headers=r1_headers)
